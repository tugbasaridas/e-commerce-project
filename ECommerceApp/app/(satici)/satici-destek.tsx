...
export default function SaticiDestekPanel() {
    ...
    return (
      <View style={styles.talepKarti}>
        ...
        <View style={styles.kartIcerik}>
          ...
          {/* DÜZELTİLEN KISIM: String çökmesini engellemek için Ternary (Soru işareti) yapısı kullanıldı */}
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top', 'left', 'right']}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.baslik}>Satıcı Destek 💌</Text>
        <View style={{ width: 40 }} />
      </View>
      ...
      {aktifSekme === 'yeni' ? (
        <ScrollView style={styles.formAlani} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
          ...
          <TextInput 
            style={styles.input}
            placeholder="Örn: Ödeme alamıyorum, sistem hatası..."
            placeholderTextColor="#A0AAB5"
            value={konu}
          ...
          <TextInput 
            ...
            placeholder="Yaşadığınız sorunu veya talebinizi detaylıca yazın..."
            placeholderTextColor="#A0AAB5"
            multiline
            numberOfLines={6}
...
const styles = StyleSheet.create({
  ...
  header: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 20, paddingTop: 10, paddingBottom: 15, backgroundColor: '#fff', borderBottomLeftRadius: 25, borderBottomRightRadius: 25, shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.03, shadowRadius: 10, elevation: 3 },
  geriButon: { padding: 5, backgroundColor: '#F8F9FA', borderRadius: 12 },
  baslik: { fontSize: 20, fontWeight: '800', color: '#2D3436' },
